...
const SECTIONS = [
  ...
  {
    title: '2. 情報の利用目的',
    content: '収集した情報は以下の目的で使用します。①サービスの提供・運営、②ユーザー認証・本人確認、③購入・納品処理、④カスタマーサポート対応、⑤サービス改善・新機能開発、⑥メール通知（購入完了・納品完了等）、⑦不正利用の検知・防止、⑧アンケート機能（投票内容の集計・表示のため。個別の投票内容は本人と運営以外には公開しません）、⑨クリエイターによる購入者ブロック機能（健全なコミュニティ運営のため、対象ユーザーのアカウントIDのみを保持します）。'
  },
  {
    title: '3. 第三者への提供',
  ...
  {
    title: '6. 開示・訂正・削除等のご請求（個人情報保護法第32条〜第35条）',
    content: 'ユーザーご本人は、保有個人データの開示・訂正・追加・削除・利用停止・第三者提供停止を当サービスに請求できます。請求にあたっては運営側で本人確認を行います（登録メールアドレスからの送信のうえ、必要に応じて追加の本人確認情報をお願いする場合があります）。請求手続および手数料は無料です。アカウント削除をご希望の場合はお問い合わせフォーム（または my-focus@my-focus.jp）よりご連絡ください。プロフィール情報の変更はマイページから直接行えます。法令上保存が必要なデータについては一定期間保持する場合があります。'
  },
  {
    title: '7. お問い合わせ',
    content: '個人情報の取り扱いに関するお問い合わせは、下記までご連絡ください。株式会社91&Co. 〒115-0043 東京都北区神谷2-21-7 / my-focus@my-focus.jp'
  },
]
    ...
    <div style={{ minHeight: '100vh', background: 'var(--mm-bg)' }}>
      ...
      <div className="mm-page-pad" style={{ maxWidth: 760, margin: '0 auto' }}>
        <div style={{ marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 13, color: 'var(--mm-text-muted)', marginTop: 6 }}>最終更新日: 2026年6月4日</p>
        </div>

        <div className="mm-card" style={{ padding: '32px 40px' }}>
          <p style={{ fontSize: 14, color: 'var(--mm-text-sub)', lineHeight: 1.8, marginBottom: 32 }}>
            My Focus（以下「当サービス」）は、ユーザーの個人情報の取り扱いについて、以下のとおりプライバシーポリシーを定めます。
          </p>
